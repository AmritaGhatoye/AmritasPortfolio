...
const Button = (props: Props & MotionProps) => {
  ...
  const classes = `${
    ...
    center ? 'mx-auto' : ''
  } w-fit font-mono capitalize rounded border-accent text-accent hover:shadow-lg hover:shadow-accent/50 hover:bg-accent-light focus:outline-none focus:bg-accent-light duration-300 cursor-pointer transition-all ${className}`;
